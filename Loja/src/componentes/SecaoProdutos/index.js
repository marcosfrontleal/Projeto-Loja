            ...
            <div className='limitar-secao'>
                ...
                <p>Todos os nossos preços são acessíveis e contam com a melhor qualidade do mercado.</p>
                    <div className='container-produtos'>
                        ...
                        <div className='box-produto'>
                            <h4>Óculos de sol</h4>
                            <img src='assets/oculos03.png' title='Óculos de grau' alt='4 óculos de grau de diferentes cores'/>
                            <p>R$ 700,00</p>
                        </div>
                        <div className='box-produto'>
                            <h2>Óculos infantil</h2>
                            <img src='assets/oculos04.png' title='Óculos de grau' alt='4 óulos de grau de diferentes cores'/>
                            <p>R$ 500,00</p>
                        </div>
                    </div>    
